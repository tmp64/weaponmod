...
//HandleNetCommand
typedef IVoidHookChain<IGameClient*, uint8_t> IRehldsHook_HandleNetCommand;
typedef IVoidHookChainRegistry<IGameClient*, uint8_t> IRehldsHookRegistry_HandleNetCommand;

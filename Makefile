...
OBJECTS = sdk/amxxmodule.cpp BSP_parse_ents.cpp    CEntity.cpp  \
CVirtHook.cpp  dllFunc.cpp hook_crowbar.cpp \
hook_info_target.cpp  meta_api.cpp natives_ammo.cpp natives_weapon.cpp \

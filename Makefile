...
OBJECTS = sdk/amxxmodule.cpp wpnmod_config.cpp wpnmod_grenade.cpp wpnmod_hooker.cpp wpnmod_hooks.cpp wpnmod_main.cpp wpnmod_memory.cpp wpnmod_natives.cpp wpnmod_parse.cpp wpnmod_pvdata.cpp wpnmod_utils.cpp wpnmod_vtable.cpp
